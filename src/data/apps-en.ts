...
export const APPS_EN: AppEn[] = [
  {
    ...
    ai: null,
    ads: { q: 'Contains Advertising', note: 'the listing also sells a \u201cNo Ads $0.99\u201d in-app purchase', src: A('950562312', 'babyname-find-it-together') },
  ...
  },
  {
    ...
    price: { q: 'Free', note: 'the listing shows no in-app-purchase section; that absence is our observation, not a quote', src: A('1336227072', 'baby-names-by-babycenter') },
    names: null,
